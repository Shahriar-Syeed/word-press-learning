...
?>
<div style="background-color: <?php echo $attributes['bgColor'] ?>;" class="multiple-choice-frontend" data-wp-interactive="create-block" <?php echo wp_interactivity_data_wp_context($ourContext) ?>>
	...
	<ul>
		...
		?>
			<li data-wp-class--fade-incorrect="callbacks.fadedClass" data-wp-class--no-click="callbacks.noClickClass" <?php echo wp_interactivity_data_wp_context($answer); ?> data-wp-on--click="actions.guessAttempt"><span data-wp-bind--hidden="!context.solved">
	...
	<div
		class="correct-message" data-wp-class--correct-message--visible="context.showCongrats">
		<svg
			xmlns="http://www.w3.org/2000/svg"
			width="24"
			height="24"
	...
	<div
		class="incorrect-message" data-wp-class--incorrect-message--visible="context.showSorry">
		<svg
			xmlns="http://www.w3.org/2000/svg"
			width="24"
			height="24"
