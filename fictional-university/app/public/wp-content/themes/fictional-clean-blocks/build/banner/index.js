...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"http://json-schema.org/trunk/block.json","apiVersion":3,"name":"ourblocktheme/banner","title":"Fictional Banner","supports":{"align":["full"]},"attributes":{"align":{"type":"string","default":"full"},"imageID":{"type":"number"},"imageURL":{"type":"string","default":"banner.fallbackimage"}},"editorScript":"file:./index.js","render":"file:./render.php"}');
...
function Edit(props) {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.useEffect)(() => {
    if (!props.attributes.imageURL) {
      props.setAttributes({
        imageURL: ourThemeData.themeImagePath + "/images/library-hero.jpg"
      });
    }
  }, []);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.useEffect)(() => {
