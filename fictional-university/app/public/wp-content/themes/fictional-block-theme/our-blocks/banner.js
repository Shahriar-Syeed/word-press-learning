...
function EditComponent(){
  ...
  <div className="page-banner__bg-image" style={{backgroundImage: "url('/wp-content/theme/fictional-block-theme/images/library-hero.jpg')"}}></div>
